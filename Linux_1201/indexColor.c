...
int main(int argc, char** argv) 
{
...
#endif 
    if(SizeImage != 0)
        SizeImage = widthBytes(bmpInfoHeader.biBitCount * bmpInfoHeader.biWidth) * 
	...
	switch(answer)
	{
		...
		case 4:
			if(bmpInfoHeader.biBitCount == 4 && bmpInfoHeader.biClrUsed == 0)
